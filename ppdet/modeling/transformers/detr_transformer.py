...
from paddle.nn.layer.transformer import (
    _convert_param_attr_to_list, _convert_attention_mask, MultiHeadAttention)
...
class DETRTransformer(nn.Layer):
    ...
    def __init__(self,
        ...
        encoder_layer = TransformerEncoderLayer(
            ...
            attn_dropout, act_dropout, normalize_before, encoder_weight_attr,
            encoder_bias_attr)
        ...
        decoder_layer = TransformerDecoderLayer(
            hidden_dim, nhead, dim_feedforward, dropout, activation,
            attn_dropout, act_dropout, normalize_before, decoder_weight_attr,
            decoder_bias_attr)
