...
def box_init(nums):
    '''
    The center of the box will be uniformly distributed
    and the wh of the box will be the half of img's wh.

    Args:
        nums: The nums of boxses

    Return:
        The init of boxes
    '''

    wl = paddle.full([nums, 2], 0.5)
    wr = paddle.full([nums, 2], 1.0)
    res = paddle.concat([wl, wr], axis=-1)
