...
class BasicLayer(nn.Layer):
    ...
    def forward(self, x, H, W):
        ...
        img_mask = paddle.fluid.layers.zeros([1, Hp, Wp, 1], dtype='float32')  # 1 Hp Wp 1
...
class SwinTransformer(nn.Layer):
    ...
    def out_shape(self):
        ...
        return [ShapeSpec(channels=self.num_features[i], stride=out_strides[i]) for i in self.out_indices]