...
class YOLOv3Loss(nn.Layer):
    ...
    def yolov3_loss(self, p, t, gt_box, anchor, downsample, scale=1., eps=1e-10):
        ...
        if self.iou_loss is not None:
            ...
            if tobj.sum() == 0:
                ...
                loss['loss_cls'] = loss_cls * b * 10


        box = [x, y, w, h]
        loss_obj = self.obj_loss(box, gt_box, obj, tobj, anchor, downsample)

        # loss_obj = F.binary_cross_entropy_with_logits(obj, iou, reduction='mean')
        loss['loss_obj'] = loss_obj * b * 20
    ...
    def forward(self, inputs, targets, anchors):
        ...
        print([(k, v.numpy()[0]) for k, v in yolo_losses.items()])
